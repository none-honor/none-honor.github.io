                        ...
                        .then(function (router) {
                            if (!deferred.promise().isRejected()) {
                                var price = this.calculate(Math.round(router.getLength() / 1000)),
                                    ...
                                    startBalloonT = '<p>Точка отправления: ' + startBalloon + '.</p>',
                                    finishBalloonT = '<p>Точка доставки: ' + finishBalloon + '.</p>',
                                    message = '<p>Расстояние: ' + distance + '.</p>';
                                jQuery('#rezultat').html(message);
                                jQuery('#pointA').html(startBalloonT);
                                jQuery('#pointB').html(finishBalloonT);
